...
<html lang="en">
  <head>
    ...
    <title>404 Page | Sunset Hotel</title>
          ...
          <ul class="nav navbar-nav navbar-right">
            ...
            <li class="dropdown">
		          ...
		          <ul class="dropdown-menu">
		            ...
		            <li class="active"><a href="{{ route('404page') }}">404 Page</a></li>
		          </ul>
		        </li>
  	    	...
  	    	<div class="col-sm-12">
  	    		<div class="section__content">
  	    			...
  	    			<!-- logo -->
	  					...
	  					<p class="section_content__desc">We’re sorry, but the page you were looking for doesn’t exist.</p>

	  					<!-- button -->
	  					<p class="section_content__action">Go back to <a href="{{ route('index-parallax') }}">Home page</a></p>
