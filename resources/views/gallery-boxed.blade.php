...
<html lang="en">
  <head>
    ...
    <title>Gallery Boxed | Sunset Hotel</title>
  ...
  <body>
          ...
          <ul class="nav navbar-nav navbar-right">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                ...
                <li class="active"><a href="{{ route('gallery-boxed') }}">Gallery boxed</a></li>
    ...
    <section class="section__header" id="section__header">
    	<div class="container">
    		<div class="row">
              ...
              <!-- Breadcrumbs -->
              <ol class="breadcrumb">
                <li><a href="{{ route('index-video') }}">Home</a></li>
    ...
    <section class="section__gallery-alt">
    	...
    	<div class="container">
          ...
          <div class="col-xs-12 col-sm-6 col-md-4 gallery__item all single-room">
          ...
          <div class="col-xs-12 col-sm-6 col-md-4 gallery__item all deluxe-room">
          ...
          <div class="col-xs-12 col-sm-6 col-md-4 gallery__item all single-room deluxe-room">
            <a href="assets/img/gallery_img4.jpg" data-lightbox="gallery" data-title="Your caption">
              <img src="assets/img/gallery_img4.jpg" class="img-responsive" alt="...">
		    	...
		    	<div class="col-xs-12 col-sm-6 col-md-4 gallery__item all lobby">
