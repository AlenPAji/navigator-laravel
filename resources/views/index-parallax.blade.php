  ...
  <body  id="index__page">
          ...
          <ul class="nav navbar-nav navbar-left">
          	<li class="dropdown">
		          ...
		          <ul class="dropdown-menu">
		            ...
		            <li class="active"><a href="{{ route('index-parallax') }}">Home Parallax</a></li>
    ...
    <!-- CONTENT
      ================================================== -->
		...
		<!-- section home -->
    <section class="section__home"  id="section__home" data-parallax="scroll" data-image-src="assets/img/parallax_bg.jpg">
      <div class="container">
        <div class="row">
          <div class="col-sm-12">
